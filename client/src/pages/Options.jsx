...
export default function Options() {
  const items = [
    { name: "Data Viz", icon: <BarChartIcon fontSize="large" className="icon" /> },
    { name: "Model Viz", icon: <AccountTree fontSize="large" className="icon" /> },
    { name: "Query Viz", icon: <QueryStatsIcon fontSize="large" className="icon" /> },
  ];
